...
public class ApfsFileTest {
	...
	public void verifyFileEqualsX() {
		String[] expected = { "true", "defaultOwnerName", "100", "defaultLastModifiedTime", "apps" };
		ApfsFile actual = x;
	...
	@Test
	public void verifyBIsDirectory() {
		assertFalse(b.isDirectory());
	}
	
	@Test
	public void verifyBisFile() {
		assertTrue(b.isFile());
	}
	
	@Test
	public void verifyBisLink() {
